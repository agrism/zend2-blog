 ...
 */
class Categories extends \Blog\Entity\Categories implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Blog\\Entity\\Categories' . "\0" . 'id', '' . "\0" . 'Blog\\Entity\\Categories' . "\0" . 'categoryKey', '' . "\0" . 'Blog\\Entity\\Categories' . "\0" . 'categoryName');
        }
